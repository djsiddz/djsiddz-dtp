...
export class DtpComponent implements OnInit, ControlValueAccessor {

  @Input() showDate: boolean = false;
  @Input() showTime: boolean = false;
  @Input() label: string;

  @Input('ngModel') _finalDate : Date = new Date();
  ...
  writeValue(value: any) {
    // console.log("called writeValue with value = ", value);
    if (value !== undefined) {
  ...
  ngOnInit() {
    // console.log("Inside init", this._finalDate);
